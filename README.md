...
```
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br>
　　　**`_maxDate(str)` :　　　　　获取某个月的最大天数,　返回　*number***</br>
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br></br>
　　　　　**参数 : *`str`* :**　　　日期字符串 [*string*]　　\*! 格式 : '[年]-[月]'或者'[年]-[月]-`[anything]`'
```javascript
<script>
console.log(_maxDate('2018-1'));　　//　31
console.log(_maxDate('2018-02'));　　//　28
</script>
```
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br>
　　　**`_getFileUrl(fileDom, index)` :　　　　　获取type="file"的input表单所选文件的本地文件地址,　返回　*string***</br>
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br></br>
　　　　　**参数 : *`fileDom`* :**　　　input元素 [*element*]</br>
　　　　　**参数 : *`index`* :**　　　　要获取本地地址的文件的索引 [*number*]　\<可选\>  \* 默认为 0
```javascript
<html>
<body>
...
fileId.onchange=function(){
    //　这里this指向input#fileId元素
    if(this.files.length>0)console.log(_getFileUrl(this));　　//　blob:null/7643220e-81fd-4732-b0e2-a073c8071671
    //　*注* 只有当input元素的已经选择了文件(即input元素的files属性的长度大于0)的情况下才能正确调用_getFileUrl()方法
};
</script>
```
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**
　　　**`_isIE()` :　　　　　判断当前浏览器是否为IE,　返回　*number/null***</br>
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br></br>
```javascript
<script>
console.log(_isIE());　　// 7|8|9|10|11|null
　　　　　　　　　　　　　//　如果当前浏览器是IE浏览器, 则返回浏览器版本; 如果不是IE浏览器, 则返回null
　　　　　　　　　　　　　// *注:* 只能判断IE7(包括IE7)以上的IE版本
</script>
```
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br>
...
```
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br>
　　　**`_amountToWords(num)` :　　　　　将数字或者数字字符串转换成中文大写金额,　返回　*string***</br>
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br></br>
　　　　　**参数 : *`num`* :**　　　数字或者数字字符串
```javascript
<script>
console.log(_amountToWords(1234567));　　//　壹百贰拾叁万肆千伍百陆拾柒元整
console.log(_amountToWords('1234567'));　　//　壹百贰拾叁万肆千伍百陆拾柒元整
console.log(_amountToWords(1234567.123));　　//　壹百贰拾叁万肆千伍百陆拾柒元壹角贰分
console.log(_amountToWords('1234567.123'));　　//　壹百贰拾叁万肆千伍百陆拾柒元壹角贰分
console.log(_amountToWords('123ab'));　　//　数据非法
</script>
```
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br>
...
**\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-**</br></br>
　　　　　　　　　　　　如果选择器对象选择的是 `window` 或者 `document` , 那么此时 `length属性的值` 为 **`null`**
　　　
```javascript
<html>
<body>
