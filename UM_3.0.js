...
function ___UM_getDom(str, i){                             //构造函数
	...
	}else if(str!==window && str!==document && !i && i!==0){
...
___UM_getDom.prototype.css=function(json){              //原型: .css()方法
	...
	if(this.arguments[1] || this.arguments[1]===0){
		for(name in json){
...
___UM_getDom.prototype.BD=function(eventName, fn){          //原型: .BD()方法    给一个元素绑定事件
	if(this.arguments[1] || this.arguments[1]===0 || this.arguments[0]===document || this.arguments[0]===window){
