...
___UM_getDom.prototype.getStyle=function(typeName){           //原型: .getStyle()方法    获取计算后的样式
	...
	if(!this.el.length){
		...
		alert('UM库 .getStyle() 方法错误: .getStyle()方法只能获取一个元素的样式的值, 当前未指定元素的索引值!');
	};
};
...
___UM_getDom.prototype.perspective=function(val1, val2){                   //原型: .perspective()方法    设置3d变换的[透视距离]和[透视原点]
	...
	if(!this.el.length){
		...
		alert('UM库 .perspective() 方法错误: .perspective()方法只能设置一个元素的[透视距离]和[透视原点], 当前未指定元素的索引值!');
	};
	return this;
};
...
___UM_getDom.prototype.BD=function(eventName, fn){          //原型: .BD()方法    给一个元素绑定事件
	if(!this.el.length || this.arguments[0]===document || this.arguments[0]===window){
		...
		alert('UM库 .BD() 方法错误: .BD()方法只能给一个元素[绑定事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.MBD=function(eventName, fn){       //原型: .MBD()方法    给一个 [ 移动端元素 ] 绑定移动端特定事件,并可以设置移动端事件的取消默认和冒泡 (移动端特定事件:touchstart、touchmove、touchend)
	if(!this.el.length || this.arguments[0]===document || this.arguments[0]===window){
		...
		alert('UM库 .MBD() 方法错误: .MBD()方法只能给一个移动端元素[绑定触摸相关事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.unBD=function(eventName, fn){      //原型: .unBD()方法    给一个元素解除绑定事件
	if(!this.el.length || this.arguments[0]===document || this.arguments[0]===window){
		...
		alert('UM库 .unBD() 方法错误: .unBD()方法只能给一个元素[解除绑定事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.BD_transitionend=function(fn){
	...
	if(!this.el.length){
		...
		alert('UM库 .BD_transitionend() 方法错误: .BD_transitionend()方法只能给一个元素[绑定transitionend事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.unBD_transitionend=function(fn){
	...
	if(!this.el.length){
		...
		alert('UM库 .unBD_transitionend() 方法错误: .unBD_transitionend()方法只能给一个元素[解除绑定transitionend事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.BD_animationstart=function(fn){
	...
	if(!this.el.length){
		...
		alert('UM库 .BD_animationstart() 方法错误: .BD_animationstart()方法只能给一个元素[绑定animationstart事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.unBD_animationstart=function(fn){
	...
	if(!this.el.length){
		...
		alert('UM库 .unBD_animationstart() 方法错误: .unBD_animationstart()方法只能给一个元素[解除绑定animationstart事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.BD_animationend=function(fn){
	...
	if(!this.el.length){
		...
		alert('UM库 .BD_animationend() 方法错误: .BD_animationend()方法只能给一个元素[绑定animationend事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.unBD_animationend=function(fn){
	...
	if(!this.el.length){
		...
		alert('UM库 .unBD_animationend() 方法错误: .unBD_animationend()方法只能给一个元素[解除绑定animationend事件], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
...
___UM_getDom.prototype.mousewheel=function(upFn, downFn){        //原型: .mousewheel()方法    设置 [ 鼠标滚轮事件 ]
	if(!this.el.length || this.arguments[0]===document || this.arguments[0]===window){
		...
		alert('UM库 .mousewheel() 方法错误: .mousewheel()方法只能给一个元素设置 [ 鼠标滚轮事件 ], 当前未指定元素的索引值!');
		return;
	};
	return this;
};
